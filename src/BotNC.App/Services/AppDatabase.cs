...
public sealed class AppDatabase
{
    ...
    private static class ReferenceDefinitions
    {
        ...
        [
            ...
            new("guild_directive_accept_button", "Botão Aceitar diretiva", "guild_directive_page.png", 748, 781, 135, 43, 685, 765, 975, 73, 0.72),
            new("guild_directive_decline_button", "Botão Desistir diretiva", "guild_directive_in_progress.png", 743, 778, 145, 44, 685, 765, 975, 73, 0.72),
            new("guild_directive_completed", "Diretivas concluídas", "guild_directive_completed.png", 741, 270, 650, 75, 650, 235, 870, 360, 0.68),
            new("guild_directive_completed_alt", "Diretivas concluídas — outro enquadramento", "guild_directive_completed_alt.png", 0, 0, 400, 80, 700, 275, 800, 250, 0.70),
            ...
            new("menu_mail", "Ícone Correio", "mail_icon.png", 0, 0, 53, 36, 1540, 920, 160, 120, 0.72),
            new("mail_page", "Página Correio", "mail_page.png", 0, 0, 165, 52, 45, 20, 250, 110, 0.67),
            new("mail_receive_all", "Receber Tudo do Correio", "mail_receive_all.png", 0, 0, 204, 66, 1640, 935, 275, 105, 0.67),
            new("mail_item_obtained", "Itens recebidos do Correio", "mail_item_obtained.png", 0, 0, 226, 58, 810, 365, 320, 140, 0.68),
            new("mail_empty", "Correio sem mensagens", "mail_empty.png", 0, 0, 328, 52, 760, 600, 420, 110, 0.65),
            new(
                "daily_shop_page",
                "Página Loja",
                "daily_shop_open.png",
            ...
            new(
                "daily_shop_coins",
                "Aba Moedas da Loja",
                "daily_shop_common.png",
                248, 105, 180, 68,
                210, 75, 260, 125,
                0.70),
            new(
                "daily_shop_common",
                "Categoria Comum da Loja",
                "daily_shop_common.png",
                30, 238, 212, 55,
                0, 190, 300, 150,
                0.70),
            ...
            new(
                ...
                "Confirmação Compra em Lote",
                "daily_shop_bulk_popup_full.png",
                616, 225, 690, 620,
                500, 150, 900, 760,
                0.65),
            ...
            new(
                "anonymous_epic_tab",
                "Aba Épica da Masmorra",
                "anonymous_epic_page.png",
                625, 110, 190, 62,
                580, 75, 285, 125,
                0.70),
            new(
                "anonymous_tenerys_card",
                "Cartão da Masmorra Anônima",
                "anonymous_tenerys_page.png",
                28, 414, 332, 146,
                10, 380, 390, 215,
                0.66),
            new(
                "anonymous_level_panel",
                "Níveis da Masmorra Anônima",
                "anonymous_tenerys_page.png",
                1487, 185, 401, 224,
                1440, 150, 480, 300,
                0.64),
            new(
                "anonymous_entry_confirmation",
                "Confirmação de entrada na Masmorra Anônima",
                "anonymous_entry_confirmation.png",
                706, 348, 508, 365,
                600, 250, 760, 540,
                0.65),
            new(
                "anonymous_arrival",
                "Chegada à Masmorra Anônima",
                "anonymous_arrival.png",
                14, 95, 302, 238,
                0, 65, 390, 310,
                0.68),
            new(
                "anonymous_map",
                "Mapa da Masmorra Anônima",
                "anonymous_map.png",
                645, 238, 630, 650,
                560, 180, 820, 780,
                0.62),
            new(
                "anonymous_go",
                "Botão Ir da Masmorra Anônima",
                "anonymous_map_selected.png",
                752, 575, 88, 72,
                350, 180, 1200, 760,
                0.66),
            new(
                "anonymous_invalid_point",
                "Local inválido na Masmorra Anônima",
                "anonymous_map.png",
                720, 94, 610, 52,
                620, 65, 760, 110,
                0.66),
